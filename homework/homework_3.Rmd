...
\begin{enumerate}
  ...
  \item Initialize a new Git repository in a local folder and create a file named README.md. Add some text to it, commit the changes, and push it to a new GitHub repository. Submit the link to your repository.
		...
		\item Clone the \href{https://github.com/wevanjohnson/2026\_Spring\_FDS}{https://github.com/wevanjohnson/2026\_Spring\_FDS} repository on your computer. Find something that could be improved (example - typo? explain something better), add files or changes to it, and upload it to GitHub. Send another well-annotated pull request to Dr. Johnson. 
	\end{enumerate}
